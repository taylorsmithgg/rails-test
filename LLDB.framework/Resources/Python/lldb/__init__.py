...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('LLDB', [dirname(__file__) + '/../../../'])
        except ImportError:
            import _lldb
            return _lldb
        if fp is not None:
            try:
                _mod = imp.load_module('LLDB', fp, pathname, description)
            finally:
                fp.close()
            return _mod
...
ePathTypeSwiftClangDir = _lldb.ePathTypeSwiftClangDir
...
class SBDebugger(_object):
    ...
    def RunCommandInterpreter(self, *args):
        """RunCommandInterpreter(self, bool auto_handle_events, bool spawn_thread)"""
